...
public function cfgCon($name, $key = "", $dbOn="on", $type = "i") {
  ...
  public function connect($app, $api_key,$debug = 'on')
  {
 ...
 *@param string $integration The Integration Name in the Campaign Builder step
 *@param string $callName the Call Name from the campaign Builder step
 *@param int contactId The contact you are adding to the campaign
 *@return the token to use in your http post which sends the cc to the app
 */
