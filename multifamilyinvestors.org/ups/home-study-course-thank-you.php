...
// upsells
if (isset ($_GET['ProductPrice']) && !empty ($_GET['ProductPrice'])) { 
...
elseif (isset ($_GET['PaymentPlan']) && !empty ($_GET['PaymentPlan'])) { 
    $ProductPrice = $_GET['PaymentPlan'];
        echo "<strong>Your Payment Plan:</strong> Your credit card has been charged $" . $ProductPrice . "0 now and will be charged again on " . $second_payment->format("M j") . " and " . $third_payment->format("M j") . ".";
}
else {
...
// street address
if (isset ($_GET['inf_field_Address2Street1']) && !empty ($_GET['inf_field_Address2Street1'])) { 
    $BillingAddress = $_GET['inf_field_Address2Street1'];
        echo "<strong>Address:</strong> " . $BillingAddress . " <br> ";
}
elseif (isset ($_GET['Contact0Address2Street1']) && !empty ($_GET['Contact0Address2Street1'])) { 
...
// street address 2
if (isset ($_GET['inf_field_StreetAddress2']) && !empty ($_GET['inf_field_StreetAddress2'])) { 
    $BillingAddress2 = $_GET['inf_field_StreetAddress2'];
        echo $BillingAddress2 . " <br>";
}
elseif (isset ($_GET['Contact0Address2Street2']) && !empty ($_GET['Contact0Address2Street2'])) { 
...
// city
if (isset ($_GET['inf_field_City2']) && !empty ($_GET['inf_field_City2'])) { 
    $BillingCity = $_GET['inf_field_City2'];
        echo "<strong>City:</strong> " . $BillingCity . ", ";
}
elseif (isset ($_GET['Contact0City2']) && !empty ($_GET['Contact0City2'])) { 
...
// state
if (isset ($_GET['inf_field_State2']) && !empty ($_GET['inf_field_State2'])) { 
    $BillingState = $_GET['inf_field_State2'];
        echo $BillingState;
}
elseif (isset ($_GET['Contact0State2']) && !empty ($_GET['Contact0State2'])) { 
...
// postal code
if (isset ($_GET['inf_field_PostalCode2']) && !empty ($_GET['inf_field_PostalCode2'])) { 
    $BillingZip = $_GET['inf_field_PostalCode2'];
        echo " " . $BillingZip;
}
elseif (isset ($_GET['Contact0PostalCode2']) && !empty ($_GET['Contact0PostalCode2'])) { 
...
<hr class="shadow">
<h2>Please Note:</h2>
<p>An email has been sent to the email address you used for your order. We will ship out your product shortly.</p>
...
<p><strong>Please Note: A receipt for your investment has been sent to your email address. <small>The charge on your credit card statement will appear as “Creative Success Alliance.”</small></strong></p>
    ...
    _kmq.push(['record', 'Viewed Page - TY Home Study Course']); // PAGE SPECIFIC EVENT
    </script>
