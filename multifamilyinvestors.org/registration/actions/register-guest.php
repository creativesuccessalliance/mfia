...
if ($app->cfgCon("contactform")) {
  ...
  $guest = array(
    ...
    '_utmsource' => $_POST['inf_custom_utmsource'],
  ...
  $returnURL = 'http://multifamilyinvestors.org/registration/thanks-guest.php?GuestFirstName=' . $_POST['GuestFirstName'] . '&GuestLastName=' . $_POST['GuestLastName'] . '&SessionDay=' . $_POST['SessionDay'] . '&SessionTime=' . $_POST['SessionTime'] . '&RegTime=' . $_POST['RegTime'] . '&inf_custom_EventHotelState=' . $_POST['EventHotelState'];
