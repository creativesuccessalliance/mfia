...
<div class="row">
	    ...
	    <p>An email with your tickets and event details has been sent to you. You can also print this page and use it to gain admission to the event.</p>
			...
			<p><a href="register-guest.php?PrimaryFirstName=<?php echo $PrimaryFirstName;?>&amp;PrimaryLastName=<?php echo $PrimaryLastName;?>&amp;PrimaryEmail=<?php echo $PrimaryEmail;?>&amp;inf_custom_EventHotelState=<?php echo $inf_custom_EventHotelState;?>&amp;SessionDay=<?php echo $SessionDay;?>&amp;SessionTime=<?php echo $SessionTime;?>&amp;RegTime=<?php echo $RegTime;?>&amp;csalsid=<?php echo $csalsid;?>" class="btn btn-success btn-lg">Click Here to Save the Seat Next to You</a></p>
			...
			<div id="wistia_6on4saqi3q" class="wistia_embed" style="width:510px;height:287px;">&nbsp;</div>
			<script charset="ISO-8859-1" src="//fast.wistia.com/assets/external/E-v1.js"></script>
			<script>
			wistiaEmbed = Wistia.embed("6on4saqi3q", {
			  videoFoam: true, 
			  autoPlay: true
			});
			</script>
