...
if ($app->cfgCon("contactform")) {
  ...
  $tag1 = 11865; // LA 1-Day November 2014 - Bringing A Guest

  // tag(s) to be applied on the guest contact
  $tag2 = 11873; // LA 1-Day November 2014 - Registered Guest
  $tag3 = 11885; // LA 1-Day November 2014 - Facebook Guest
  ...
  $returnURL = 'http://multifamilyinvestors.org/thanks-guest.php?guestfirstname=' . $_POST['GuestFirstName'] . '&guestlastname=' . $_POST['GuestLastName'] . '&sessiontime=' . $_POST['SessionTime'];
