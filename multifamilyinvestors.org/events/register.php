...
<div id="register-now-container" class="container">
...
<div class="panel panel-primary">
	        ...
	        <form accept-charset="UTF-8" action="https://m160.infusionsoft.com/app/form/process/a851e1d747dcdc9cb315a4102b93846f" class="infusion-form" method="POST" data-parsley-validate>
			     <input name="inf_form_xid" type="hidden" value="a851e1d747dcdc9cb315a4102b93846f" />
    			<input name="inf_form_name" type="hidden" value="Facebook - Primary" />
	            ...
	            <input name="inf_custom_MarketingSource" type="hidden" value="Facebook" />
	            ...
	            <div class="checkbox">
	                <label class="checkbox-label">
	                    <input type="checkbox" id="inf_option_TextReminder" name="inf_option_TextReminder" value="34494">Would you like to receive a text reminder?
	                </label>
	            </div>
				<div class="form-group">
	    ...
	    <img src="../img/apartment-building.jpg" alt="Multi-Family Apartment" class="img-responsive img-center">
	         <div style="background-color: #FBFBFB; border:1px solid #F2F2F2; border-top: none; padding: 13px 15px 2px;">
	                  ...
	                  <span class="event-date"><i class="fa fa-calendar"></i> <?php echo $EventDate;?></span>
                                <br><span class="event-location"><i class="fa fa-clock-o"></i> 
