...
if ($app->cfgCon("contactform")) {
  ...
  $returnURL = 'http://multifamilyinvestors.org/events/thanks-guest.php?GuestFirstName=' . $_POST['GuestFirstName'] . '&GuestLastName=' . $_POST['GuestLastName'] . '&SessionDay=' . $_POST['SessionDay'] . '&SessionTime=' . $_POST['SessionTime'] . '&RegTime=' . $_POST['RegTime'];
