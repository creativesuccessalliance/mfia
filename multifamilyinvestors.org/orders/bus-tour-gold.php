...
<div class="container form">
	<div class="row">
		<div class="col-md-7">
			...
			<form id="orderForm" name="orderForm" role="form" action="https://m160.infusionsoft.com/AddForms/processFormSecure.jsp" method="post" data-parsley-validate>
				...
				<input value="9ba8fbe0913b89aca6e5533dfc8cd603" id="infusion_xid" type="hidden" name="infusion_xid" />
				<input value="CustomFormSale" id="infusion_type" type="hidden" name="infusion_type" />
				<input value="USREIA: Bus Tour Gold" id="infusion_name" type="hidden" name="infusion_name" />
					...
					<div class="panel-body">
						...
						<div class="radio" style="margin-bottom: 0;">
							<label>
								...
								<a href="#what-you-get" data-toggle="modal" data-target="#what-you-get"><strong class="text-danger">Getting Started Fast - Following In My Footsteps &amp; Special Bonuses</strong></a> - <strong>only $27</strong>
							</label>
						</div>
						<!-- order button -->
						...
						<div id="paypal" class="alert alert-warning text-center">
							...
							<input type="hidden" name="hosted_button_id" value="SGHD72GCQEXWN">
		...
		<div class="col-md-5">
			...
			<p>
			US: <i class="fa fa-phone"></i> <strong>1-800-554-1567</strong>
			Intl: <i class="fa fa-phone"></i><strong> 1-781-982-5700</strong>
			</p>
			<p>Mon-Thu: 8:00am - 7:00pm EST<br>
			Fri: 8:00am - 4:00pm EST</p>
			<p>Our USREIA loyalty team looks forward to helping you with your inquiry. We respond to email messages in the order that they are received, and we will respond to your email as quickly as possible.</p>
			<p><i class="fa fa-envelope"></i> Email: <a href="mailto:support@usrealestateassociation.com">support@usrealestateassociation.com</a>
			<hr>
			<h3>Rest Assured 100% Satisfaction Guaranteed</h3>
			<p>If you are not completely convinced that my <strong>Brockton Bus Tour & Bonuses</strong> are worth their value, you may claim a full refund, no questions asked.</p>
	...
	_kmq.push(['trackSubmit', 'orderForm', 'CartSubmit', {'Type':'Plan','Plan':'MFBTGold'}]);
	_kmq.push(['record', 'View Cart MFBTGold']); //PAGE SPECIFIC EVENT
	_kmq.push(['record', 'CartView']); //CATEGORY EVENT
	</script>
