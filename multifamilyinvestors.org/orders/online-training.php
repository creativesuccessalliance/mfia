...
if ($plan == '3pay') {
    ...
    $form_code = <<<EOD
    <input type="hidden" name="infusion_xid" value="e25901ee89ec182bad594f6cbbe479b3" id="infusion_xid" />
    <input type="hidden" name="infusion_type" value="CustomFormSale" id="infusion_type" />
    <input type="hidden" name="infusion_name" value="AHR Online Training - $515x3" id="infusion_name" />
EOD;
...
//default to 1 payment
    ...
    $form_code = <<<EOD
    <input value="bcfd4560ae35df6f4a9cfa0d4b24f12d" type="hidden" name="infusion_xid" id="infusion_xid" />
    <input value="CustomFormSale" type="hidden" name="infusion_type" id="infusion_type" />
    <input type="hidden" name="infusion_name" value="AHR Online Training - $1495" id="infusion_name" />
EOD;
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <form id="orderForm" name="orderForm" role="form" action="https://m160.infusionsoft.com/AddForms/processFormSecure.jsp" method="post" data-parsley-validate>
                ...
                <input type="hidden" name="PromoCode" value="5889: AHR Online Training 04/2015" id="PromoCode" />
            ...
            <div class="modal-content">
              ...
              #8C0000 40px
                ...
                <p class="text-center">Click the button below to get my complete <strong>Apartment House Riches</strong> home study course & <strong>Live Event!</strong> You will be on your way to <strong>fast success</strong> in no time!</p>
                   ...
                   <p>
                    <a href="online-training.php?plan=3pay"><img src="themes/mf/img/exit-pop/btn-3payments.gif" class="img-responsive img-center"></a></p>
                </div>
            </div>
        </div>
    </div>
