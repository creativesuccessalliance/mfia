...
if ($plan == 'silver') {
	...
	<input value="MFIA: Bus Tour Silver" id="infusion_name" type="hidden" name="infusion_name" />
EOD;

    $form_price = <<<EOD
    <input type="radio" class="radio" name="PurchaseType" value="A" checked>
    <input id="ProductId" type="hidden" value="1386" name="ProductId" /
	<input name="PayTotal_A" type="hidden" value="19.0" id="PayTotal_A" />
	<input name="PlanCount_A" type="hidden" value="1" id="PlanCount_A" />
	<a href="#what-you-get" data-toggle="modal" data-target="#what-you-get"><strong class="text-danger">Getting Started Fast DVDs &amp; Special Bonuses</strong></a> - <strong>only $19</strong>
EOD;

    $kiss_code = <<<EOD
    <script type="text/javascript">
    _kmq.push(['identify', '$inf_field_Email']); // IDENTIFY CONTACT
    _kmq.push(['record', 'Viewed Page - OP Bus Tour Silver']); // PAGE SPECIFIC EVENT
    </script>
EOD;
}
...
elseif ($plan == 'gold') {
    ...
    $form_code = <<<EOD
    <input value="9ba8fbe0913b89aca6e5533dfc8cd603" name="infusion_xid" id="infusion_xid" type="hidden" />
	<input value="CustomFormSale" name="infusion_type" id="infusion_type" type="hidden" />
	<input value="MFIA: Bus Tour Gold" name="infusion_name" id="infusion_name" type="hidden" />
EOD;

    $form_price = <<<EOD
    <input type="radio" class="radio" name="PurchaseType" value="A" checked>
    <input id="ProductId" type="hidden" value="1384" name="ProductId" />
	<input name="PayTotal_A" type="hidden" value="27.0" id="PayTotal_A" />
	<input name="PlanCount_A" type="hidden" value="1" id="PlanCount_A" />
	<a href="#what-you-get" data-toggle="modal" data-target="#what-you-get"><strong class="text-danger">Getting Started Fast DVDs &amp; Special Bonuses</strong></a> - <strong>only $27</strong>
EOD;

    $kiss_code = <<<EOD
    <script type="text/javascript">
    _kmq.push(['identify', '$inf_field_Email']); // IDENTIFY CONTACT
    _kmq.push(['record', 'Viewed Page - OP Bus Tour Gold']); // PAGE SPECIFIC EVENT
    </script>
EOD;
}
...
// default to platinum
    ...
    $form_code = <<<EOD
    <input type="hidden" value="f5b19709f6e97ac171860bd9d4e9342b" id="infusion_xid" name="infusion_xid" />
	<input type="hidden" value="CustomFormSale" id="infusion_type" name="infusion_type" />
	<input type="hidden" value="MFIA: Bus Tour Platinum" id="infusion_name" name="infusion_name" />
EOD;

    $form_price = <<<EOD
    <input type="radio" class="radio" name="PurchaseType" value="A" checked>
    <input id="ProductId" type="hidden" value="1380" name="ProductId" />
	<input name="PayTotal_A" type="hidden" value="27.0" id="PayTotal_A" />
	<input name="PlanCount_A" type="hidden" value="1" id="PlanCount_A" />
	<a href="#what-you-get" data-toggle="modal" data-target="#what-you-get"><strong class="text-danger">Getting Started Fast DVDs &amp; Special Bonuses</strong></a> - <strong>only $27</strong>
EOD;
    ...
    <script type="text/javascript">
    _kmq.push(['identify', '$inf_field_Email']); // IDENTIFY CONTACT
    _kmq.push(['record', 'Viewed Page - OP Bus Tour Platinum']); // PAGE SPECIFIC EVENT
    </script>
EOD;
}
?>
	...
	<div class="row">
		<div class="col-md-7">
			...
			<form id="orderForm" name="orderForm" role="form" action="https://m160.infusionsoft.com/AddForms/processFormSecure.jsp" method="post" data-parsley-validate>
				...
				<input type="hidden" value="MKT037: MFIA Funnel" id="PromoCode" name="PromoCode" />
		...
		<div class="col-md-5">
			...
			<p>If you are not completely convinced that my <strong>Getting Started Fast DVDs & Bonuses</strong> are worth their value, you may claim a full refund, no questions asked.</p>
