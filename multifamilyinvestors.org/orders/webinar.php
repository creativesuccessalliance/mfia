...
if ($plan == '3pay') {
    ...
    $form_code = <<<EOD
    <input type="hidden" name="infusion_xid" value="42def3994c1a258b6a31bb3444bafa49" id="infusion_xid" />
    <input type="hidden" name="infusion_type" value="CustomFormSale" id="infusion_type" />
    <input type="hidden" name="infusion_name" value="MFIA: AHR Webinar - $515x3" id="infusion_name" />
EOD;

//infusionsoft price inputs
    $payment_plan = <<<EOD
    <input type="radio" class="radio" name="PurchaseType" value="A" checked> <a href="#what-you-get" data-toggle="modal" data-target="#what-you-get-ahr"><strong class="text-danger">Home Study Course & Live Event</a></strong> <strong>- $515.00 charged today, then again on {$second_payment->format("M j")} and {$third_payment->format("M j")}.</strong>
    <br><em class="small">Includes <strong>FREE</strong> UPS Ground Shipping!</em>
    <input value="1453" type="hidden" name="ProductId" id="ProductId" />
    <input type="hidden" name="PayTotal_A" value="1545.0" id="PayTotal_A" />
    <input type="hidden" name="PlanCount_A" value="2" id="PlanCount_A" />
EOD;
    ...
    _kmq.push(['record', 'Viewed Page - OP Webinar $515x3']); // PAGE SPECIFIC EVENT
    </script>
EOD;
}
...
//default to 1 payment
    ...
    $form_code = <<<EOD
    <input value="dcad8340a12d63649fea1500be9a5cbb" type="hidden" name="infusion_xid" id="infusion_xid" />
    <input value="CustomFormSale" type="hidden" name="infusion_type" id="infusion_type" />
    <input type="hidden" name="infusion_name" value="MFIA: AHR Webinar - $1495" id="infusion_name" />
EOD;
...
EOD;
    ...
    <script type="text/javascript">
    _kmq.push(['identify', '$inf_field_Email']); // IDENTIFY CONTACT
    _kmq.push(['record', 'Viewed Page - OP Webinar $1495 ']); // PAGE SPECIFIC EVENT
    </script>
EOD;
}
?>
    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <form id="orderForm" name="orderForm" role="form" action="https://m160.infusionsoft.com/AddForms/processFormSecure.jsp" method="post" data-parsley-validate>
                ...
                <input type="hidden" name="PromoCode" value="MKT037: MFIA Funnel" id="PromoCode" />
            ...
            <div class="modal-content">
              ...
              #8C0000 40px
                ...
                <p class="text-center">Click the button below to get my complete <strong>Apartment House Riches</strong> home study course & <strong>Live Event!</strong> You will be on your way to <strong>fast success</strong> in no time!</p>
                   ...
                   <p>
                    <a href="webinar.php?plan=3pay"><img src="themes/mf/img/exit-pop/btn-3payments.gif" class="img-responsive img-center"></a></p>
                </div>
            </div>
        </div>
    </div>
